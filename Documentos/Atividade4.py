...
"""
# def calcular_area(a1,a2):
#     return(a1*a2)

# print(calcular_area(7,6))
"""
2.Crie uma função em Python para mostrar a área de um círculo, considere a seguinte fórmula:A=3,14*r*r
"""
# def circulo_area (r):
#     return(3.14*r*r)
# print(circulo_area(7))
"""
